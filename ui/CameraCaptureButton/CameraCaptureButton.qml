...
Rectangle {
    ...
    anchors.topMargin:  parent.height * 0.139
    // The color now responds to our custom state properties
    color: isDown ? "red" : (isHovered ? "#590404" : "red")
    ...
    Image {
        ...
        source: "file:///D:/My Workspace/Qt&QML/Scratch/PhotoBooth/ui/assets/Camera_ICON.png"
