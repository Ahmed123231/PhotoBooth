...
Rectangle {
    ...
    anchors.topMargin : parent.height  * 0.3125
    // The color now responds to our custom state properties
    color: isDown ? "#30B3FF" : (isHovered ? "#0e43b5" : "#30B3FF")
    ...
    Image {
        ...
        source: "file:///D:/My Workspace/Qt&QML/Scratch/PhotoBooth/ui/assets/Printer_ICON.png"
